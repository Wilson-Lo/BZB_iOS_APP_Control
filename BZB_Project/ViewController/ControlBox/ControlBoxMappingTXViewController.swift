...
class ControlBoxMappingTXViewController : BaseViewController{
    ...
    override func viewDidLoad() {
        print("ControlBoxMappingTXViewController-viewDidLoad")
        super.viewDidLoad()
        self.initialUI()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("ControlBoxMappingTXViewController-viewWillAppear")
    ...
    override func viewDidDisappear(_ animated: Bool) {
        print("ControlBoxMappingTXViewController-viewDidDisappear")
        
    }
    
}

extension ControlBoxMappingTXViewController{
...
extension ControlBoxMappingTXViewController : UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.deviceName.text = self.txList[indexPath.item].name
        cell.groupIDText.text = self.txList[indexPath.item].group_id
        cell.ipText.text = self.txList[indexPath.item].ip
        if(self.txList[indexPath.item].alive != "y"){
...
extension ControlBoxMappingTXViewController: UICollectionViewDelegateFlowLayout {
